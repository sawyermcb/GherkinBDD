...
# ----------------------------------------------------------------------
  ...
  def calculate_retirement_age(birth_year):
    birth_year = CucumberBasket._validate_birth_year(birth_year)
...
# ----------------------------------------------------------------------
  ...
  def calculate_retirement_date(birth_year, birth_month, age_years, age_months):
    birth_year = RetireCalc._validate_birth_year(birth_year)
    birth_month = RetireCalc._validate_birth_month(birth_month)
    age_years = RetireCalc._validate_age_year(age_years)
    age_months = RetireCalc._validate_age_month(age_months)
...
#def test_validate_birth_month():
  #try/catch particular exceptions - value error in this case
  #test boundaries 1 and 12, above, below and within
#  assert(_validate_birth_month(5) == 5)
#  with pytest.raises(ValueError):
#    _validate_birth_month(13)
#    _validate_bird_month(0)
...
# ----------------------------------------------------------------------
x = RetireCalc.calculate_retirement_date(1970, 4, 66, 1)
print(x)